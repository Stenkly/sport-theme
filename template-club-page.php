        ...
        while ( have_posts() ) :
            ...
            if ( empty($clean_content) || strlen($clean_content) < 150 ) {
                ...
                if ($current_slug === 'storia' || strpos($titolo_check, 'storia') !== false) {
                    ...
                    echo '<p>La società divenne rapidamente un punto di riferimento sportivo per tutta la valle, grazie a un ambiente favorevole, ottimi allenatori e ad una solida comunità. A questo periodo eroico sono legati nomi importanti come Mario Banfi, Flaminio Petrocchi e Gino Gova, mentre già negli anni Trenta si distinsero i fratelli Zambelli, in particolare il portiere Emilio, detto "Zamorra".</p>';
