        ...
        while ( have_posts() ) :
            ...
            if ( empty($clean_content) || strlen($clean_content) < 150 ) {
                ...
                if ($current_slug === 'storia' || strpos($titolo_check, 'storia') !== false) {
                    ...
                    echo '<h3>Nel secondo dopoguerra nacque l’Associazione Calcio Taverne, sostenuta da grande entusiasmo popolare.</h3>';
                    echo '<p>La società divenne un punto di riferimento sportivo per tutta la valle, grazie a un ambiente favorevole, buoni allenatori e una solida comunità. A questo periodo, definito “eroico”, sono legati nomi importanti come Mario Banfi, Flaminio Petrocchi e Gino Gova, mentre già negli anni Trenta si distinsero a livello regionali i fratelli Zambelli, in particolare il portiere Emilio, soprannominato “Zamorra”.</p>';
                    ...
                    echo '<h3>La prima squadra come traino dell\'intera attività agonistica e societaria dell\'AC Taverne.</h3>';
                    ...
                    echo '<h3>Parallelamente ai risultati della prima squadra, il club ha sempre attribuito grande importanza al settore giovanile. I ragazzi delle categorie Allievi, sempre più numerosi, rappresentano una risorsa fondamentale e una prospettiva concreta per il futuro.</h3>';
                    ...
                    echo '<li>Campione ticinese di Seconda Divisione (stagione 1958-1959)</li>';
