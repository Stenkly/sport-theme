...
<main id="primary" class="site-main page-infrastruttura">
    ...
    <div class="container" style="padding-top: 0px; padding-bottom: 60px;">
        ...
        <div id="tab-campo" class="infra-tab-content" style="display: block;">
            ...
            <p style="color: white; font-size: 22px; line-height: 1.3; font-weight: bold; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 30px; max-width: 900px;">
        ...
        <div id="tab-buvette" class="infra-tab-content" style="display: none;">
            ...
            <p style="color: white; font-size: 22px; line-height: 1.3; font-weight: bold; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 40px; max-width: 900px;">
