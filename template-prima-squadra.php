        ...
        <div style="position: relative;">
            <div id="team-carousel" style="display: flex; gap: 16px; overflow: hidden; scroll-behavior: smooth;">
                ...
                <a href="#" class="open-player-modal team-slide"
                   ...
                   style="text-decoration: none; flex: 0 0 calc(25% - 12px); min-width: 0; display: block; border-radius: 4px; overflow: hidden; transition: transform 0.3s;"
                   onmouseover="this.style.transform='scale(1.02)'" onmouseout="this.style.transform='scale(1)'">
                    <div class="player-card" style="position: relative; aspect-ratio: 3/4; overflow: hidden; background-color: #111;">
                        ...
                        <div class="player-info" style="position: absolute; bottom: -4px; left: 12px; z-index: 2; flex-direction: column; gap: 0; padding: 0;">
                            <?php if(!empty($numero)): ?>
                            <span class="player-number" style="display: block; font-size: 50px; font-weight: 700; margin-bottom: 31px; line-height: 1; color: #F9EA86;"><?php echo esc_html($numero); ?></span>
                            <?php elseif(!empty($ruolo_spec)): ?>
                            <span class="staff-role text-primary" style="display: block; font-size: 11px; font-weight: 700; text-transform: uppercase; margin-bottom: 31px; letter-spacing: 1px;"><?php echo esc_html($ruolo_spec); ?></span>
                            <?php endif; ?>
