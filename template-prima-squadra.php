                   ...
                   onmouseover="this.style.transform='scale(1.02)'" onmouseout="this.style.transform='scale(1)'">
                    <div class="player-card" style="position: relative; aspect-ratio: 3/4; overflow: hidden; background-color: #111;">
                        ...
                        <div class="player-info" style="position: absolute; bottom: 2px; left: 12px; z-index: 2; flex-direction: column; gap: 0; padding: 0;">
                            <?php if(!empty($numero)): ?>
                            <span class="player-number" style="display: block; font-size: 50px; font-weight: 700; margin-bottom: 19px; line-height: 1; color: #F9EA86;"><?php echo esc_html($numero); ?></span>
                            <?php elseif(!empty($ruolo_spec)): ?>
                            <span class="staff-role text-primary" style="display: block; font-size: 11px; font-weight: 700; text-transform: uppercase; margin-bottom: 19px; letter-spacing: 1px;"><?php echo esc_html($ruolo_spec); ?></span>
                            <?php endif; ?>
                            <span class="player-name text-white" style="display: block; font-size: 34px; font-weight: 700; line-height: 1.2; margin-top: 0px;">
                                ...
                                <span style="color: #F9EA86; display:block; margin-top:8px;"><?php echo esc_html($nome_riga2); ?></span>
                            </span>
                        </div>
                    </div>
                </a>
