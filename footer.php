	...
	<footer id="colophon" class="site-footer">
        ...
        <div class="footer-mega container">
            <div class="fm-col fm-col-1">
                ...
                <a href="mailto:scoutingactaverne@gmail.com">scoutingactaverne@gmail.com</a>
                <a href="mailto:a.spoggi@actaverne.com">a.spoggi@actaverne.com</a></p>
                <div class="fm-social">
            ...
            <div class="fm-col">
                ...
                <a href="<?php echo site_url('/partner'); ?>">Partner</a>
            </div>
            <div class="fm-col">
                <h4>TEAM</h4>
