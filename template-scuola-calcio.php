...
<main id="primary" class="site-main page-scuola-calcio">
    ...
    <div class="container scuola-calcio-content" style="padding-top: 10px; padding-bottom: 60px;">
        ...
        <hr class="sc-divider" style="border: 0; border-top: 5px solid rgba(255,255,255,0.9); margin-bottom: 40px; margin-top: 0;">
        ...
        <hr class="sc-divider" style="border: 0; border-top: 5px solid rgba(255,255,255,0.9); margin-bottom: 40px;">
