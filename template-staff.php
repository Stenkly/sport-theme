            ...
            <div class="news-hero-content container" style="position: absolute; bottom: 40px; left: 0; right: 0; text-align: left;">
                ...
                <div class="page-submenu" style="display: flex; gap: 20px;">
                    <h4 style="margin: 0; display: inline-block;">
                        <a href="<?php echo esc_url( site_url('/rosa') ); ?>" class="btn-outline-hover" style="padding: 10px 40px; font-weight: 700; text-transform: uppercase; font-size: 22px; text-decoration: none; border: 2px solid white; background-color: transparent; color: white; transition: all 0.3s; display: inline-block;">ROSA</a>
                    </h4>
                    <h4 style="margin: 0; display: inline-block;">
                        <a href="<?php echo esc_url( site_url('/staff') ); ?>" style="padding: 10px 40px; font-weight: 700; text-transform: uppercase; font-size: 22px; text-decoration: none; border: 2px solid var(--c-primary); background-color: var(--c-primary); color: var(--c-black); display: inline-block;">STAFF</a>
                    </h4>
                </div>
            </div>
        </div>
            ...
            <a href="#" class="open-player-modal" 
               ...
               style="text-decoration: none; display: block; overflow: hidden; transition: transform 0.3s;" onmouseover="this.style.transform='scale(1.02)'" onmouseout="this.style.transform='scale(1)'">
                <div class="player-card" style="position: relative; aspect-ratio: 3/4; overflow: hidden; background-color: #111;">
                    ...
                    <div class="player-info" style="position: absolute; bottom: 10px; left: 12px; z-index: 2; flex-direction: column; gap: 0; padding: 0;">
                        <?php if(!empty($ruolo_spec)): ?>
                        <span class="staff-role text-primary" style="display: block; font-size: 19px; font-weight: 700; text-transform: uppercase; margin-bottom: 35px; letter-spacing: 1px;"><?php echo esc_html($ruolo_spec); ?></span>
                        <?php endif; ?>
